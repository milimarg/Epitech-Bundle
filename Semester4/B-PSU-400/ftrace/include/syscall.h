...
*/
    ...
    #define VARGS 16
    #define CONS_STRUC_IOVEC_P 17
    #define FD_SET_P 18
    #define STRUCT_TIMEVAL_P 19
    #define VOID 20
    #define STRUCT_SHMID_DS_P 23
    #define CONS_STRUC_TIMESPE_P 24
    ...
    #define UNUM32_T 114
    #define STRUC_POLLFD_P 115
    #define CONS_SIGSET_P 116
...
static syscall_t table[330] = {
    ...
    {7, "poll", 3, NUM, {STRUCT_FD_P, USIGN, NUM, 0, 0, 0}},
    ...
    {13, "rt_sigaction", 4, NUM, {NUM, SIGINFO_T_P, SIGINFO_T_P, NUM, 0, 0}},
    {14, "rt_sigprocmask", 4, NUM,
        {NUM, CONST_KERNEL_SIGSET_T_P, KERNEL_SIGSET_T_P, NUM, 0, 0}},
    {15, "rt_sigreturn", 1, NUM, {STACK_T_P, 0, 0, 0, 0, 0}},
    {16, "ioctl", 3, NUM, {NUM, USIGN, VARGS, 0, 0, 0}},
    {17, "pread64", 4, NUM, {NUM, VOID_P, NUM, OFF64_T, 0, 0}},
    {18, "pwrite64", 4, NUM, {NUM, VOID_P, NUM, OFF64_T, 0, 0}},
    {19, "readv", 3, NUM, {NUM, CONS_STRUC_IOVEC_P, NUM, 0, 0, 0}},
    {20, "writev", 3, NUM, {NUM, CONS_STRUC_IOVEC_P, NUM, 0, 0, 0}},
    ...
    {25, "mremap", 5, PVOID, {VOID_P, NUM, NUM, NUM, VOID_P, 0}},
    ...
    {35, "nanosleep", 2, NUM,
        {CONS_STRUC_TIMESPE_P, STRUCT_TIMESPEC_P, 0, 0, 0, 0}},
    {36, "getitimer", 2, NUM, {NUM, STRUCT_ITIMERVAL_P, 0, 0, 0, 0}},
    {37, "alarm", 1, USIGN, {USIGN, 0, 0, 0, 0, 0}},
    {38, "setitimer", 3, NUM,
    ...
    {46, "sendmsg", 3, NUM,
        {NUM, CONST_STRUCT_MSGHDR_P, NUM, 0, 0, 0}},
    ...
    {55, "getsockopt", 5, NUM,
        {NUM, NUM, NUM, VOID_P, SOCKLEN_T_P, 0}},
    {56, "clone", 2, NUM, {VOID_P, NUM, 0, 0, 0, 0}},
    ...
    {78, "getdents", 3, NUM,
        {USIGN, STRUCT_LINUX_DIRENT_P, USIGN, 0, 0, 0}},
    {79, "getcwd", 2, NUM, {STRING, USIGN, 0, 0, 0, 0}},
    ...
    {127, "rt_sigpending", 2, NUM, {SIGINFO_T_P, NUM, 0, 0, 0}},
    {128, "rt_sigtimedwait", 4, NUM,
        {SIGINFO_T_P, SIGINFO_T_P, STRUCT_TIMESPEC_P, NUM, 0, 0}},
    {129, "rt_sigqueueinfo", 3, NUM, {NUM, NUM, SIGINFO_T_P, 0, 0, 0}},
    {130, "rt_sigsuspend", 2, NUM, {CONS_SIGSET_P, NUM, 0, 0, 0, 0}},
    ...
    {135, "personality", 1, NUM, {USIGN, 0, 0, 0, 0, 0}},
    ...
    {154, "modify_ldt", 3, NUM, {NUM, VOID_P, USIGN, 0, 0, 0}},
    {155, "pivot_root", 2, NUM, {STRING, STRING, 0, 0, 0, 0}},
    {156, "_sysctl", 1, NUM, {STRUCT____ARGS_P, 0, 0, 0, 0, 0}},
    {157, "prctl", 5, NUM, {NUM, USIGN, USIGN, USIGN, USIGN, 0}},
    {158, "arch_prctl", 2, NUM, {NUM, USIGN, 0, 0, 0, 0}},
    ...
    {165, "mount", 5, NUM,
        {STRING, STRING, STRING, USIGN, CONST_VOID_P, 0}},
    ...
    {173, "ioperm", 3, NUM, {USIGN, USIGN, NUM, 0, 0, 0}},
    {174, "create_module", 2, CADDR_T, {STRING, NUM, 0, 0, 0, 0}},
    {175, "init_module", 3, NUM, {VOID_P, USIGN, STRING, 0, 0, 0}},
    ...
    {181, "getpmsg", 5, NUM, {NUM, VOID_P, VOID_P, NUM_P, NUM, 0}},
    {182, "putpmsg", 4, NUM,
        {NUM, STRUCT_SEMBUF_P, STRUCT_SEMBUF_P, NUM, 0, 0}},
    {183, "afs_syscall", 6, NUM, {NUM, VOID_P, NUM, NUM, NUM, NUM}},
    {184, "tuxcall", 2, NUM, {NUM, VOID_P, 0, 0, 0, 0}},
    {185, "security", 4, NUM, {STRING, NUM, DEV_T, U64, 0, 0}},
    ...
    {206, "io_setup", 2, NUM, {USIGN, AIO_CONTEXT_T_P, 0, 0, 0, 0}},
    ...
    {214, "epoll_ctl_old", 3, NUM, {NUM, NUM, STRUCT_EPOLL_EVENT_P, 0, 0, 0}},
    {215, "epoll_wait_old", 3, NUM, {NUM, STRUCT_EPOLL_EVENT_P, NUM, 0, 0, 0}},
    {216, "remap_file_pages", 5, NUM, {VOID_P, NUM, NUM, NUM, NUM, 0}},
    {217, "getdents64", 3, NUM,
        {USIGN, STRUCT_LINUX_DIRENT64_P, USIGN, 0, 0, 0}},
    {218, "set_tid_address", 1, NUM, {NUM_P, 0, 0, 0, 0, 0}},
    {219, "restart_syscall", 1, NUM, {VOID, 0, 0, 0, 0, 0}},
    {220, "semtimedop", 4, NUM,
        {NUM, STRUCT_SEMBUF_P, NUM, CONS_STRUC_TIMESPE_P, 0, 0}},
    {221, "fadvise64", 4, NUM, {NUM, OFF64_T, OFF64_T, NUM, 0, 0}},
    ...
    {227, "clock_settime", 2, NUM,
        {CLOCKID_T, CONS_STRUC_TIMESPE_P, 0, 0, 0, 0}},
    ...
    {230, "clock_nanosleep", 4, NUM,
        {CLOCKID_T, NUM, CONS_STRUC_TIMESPE_P, STRUCT_TIMESPEC_P, 0, 0}},
    ...
    {236, "vserver", 4, NUM, {NUM, STRING, NUM, NUM, 0, 0}},
    {237, "mbind", 6, NUM,
        {VOID_P, USIGN, NUM, CONST_USIGN_P, USIGN, USIGN}},
    {238, "set_mempolicy", 3, NUM, {NUM, CONST_USIGN_P, USIGN, 0, 0, 0}},
    {239, "get_mempolicy", 5, NUM,
        {NUM_P, USIGN_P, USIGN, VOID_P, USIGN, 0}},
    {240, "mq_open", 2, MQD_T, {STRING, NUM, 0, 0, 0, 0}},
    {241, "mq_unlink", 1, NUM, {STRING, 0, 0, 0, 0, 0}},
    {242, "mq_timedsend", 5, NUM,
        {MQD_T, STRING, NUM, USIGN, CONS_STRUC_TIMESPE_P, 0}},
    {243, "mq_timedreceive", 5, NUM,
        {MQD_T, STRING, NUM, USIGN_P, CONS_STRUC_TIMESPE_P, 0}},
    ...
    {246, "kexec_load", 4, NUM,
        {USIGN, USIGN, STRUCT_KEXEC_SEGMENT_P, USIGN, 0, 0}},
    ...
    {256, "migrate_pages", 4, NUM,
        {NUM, USIGN, CONST_USIGN_P, CONST_USIGN_P, 0, 0}},
    ...
    {270, "pselect6", 6, NUM,
        {NUM, FD_SET_P, FD_SET_P, FD_SET_P, STRUCT_TIMESPEC_P, VOID_P}},
    {271, "ppoll", 4, NUM,
        {STRUC_POLLFD_P, USIGN, CONS_STRUC_TIMESPE_P, CONS_SIGSET_P, 0, 0}},
    ...
    {275, "splice", 6, NUM, {NUM, LNUM_P, NUM, LNUM_P, NUM, USIGN}},
    {276, "tee", 4, NUM, {NUM, NUM, NUM, USIGN, 0, 0}},
    {277, "sync_file_range", 4, NUM, {NUM, OFF64_T, OFF64_T, USIGN, 0, 0}},
    {278, "vmsplice", 4, NUM,
        {NUM, CONS_STRUC_IOVEC_P, USIGN, USIGN, 0, 0}},
    {279, "move_pages", 6, NUM,
        {NUM, USIGN, VOID_P, CONST_NUM_P, NUM_P, NUM}},
    {280, "utimensat", 4, NUM,
        {NUM, STRING, CONST_STRUCT_TIMESPEC, NUM, 0, 0}},
    {281, "epoll_pwait", 5, NUM,
        {NUM, STRUCT_EPOLL_EVENT_P, NUM, NUM, CONS_SIGSET_P, 0}},
    {282, "signalfd", 3, NUM, {NUM, CONS_SIGSET_P, NUM, 0, 0, 0}},
    {283, "timerfd_create", 2, NUM, {NUM, NUM, 0, 0, 0, 0}},
    {284, "eventfd", 2, NUM, {USIGN, NUM, 0, 0, 0, 0}},
    ...
    {289, "signalfd4", 4, NUM, {NUM, CONS_SIGSET_P, NUM, NUM, 0, 0}},
    ...
    {295, "preadv", 4, NUM, {NUM, CONS_STRUC_IOVEC_P, NUM, NUM, 0, 0}},
    {296, "pwritev", 4, NUM, {NUM, CONS_STRUC_IOVEC_P, NUM, NUM, 0, 0}},
    {297, "rt_tgsigqueueinfo", 4, NUM, {NUM, NUM, NUM, SIGINFO_T_P, 0, 0}},
    {298, "perf_event_open", 5, NUM,
        {STRUCT_PERF_EVENT_ATTR_P, NUM, NUM, NUM, USIGN, 0}},
    {299, "recvmmsg", 5, NUM,
        {NUM, STRUCT_MMSGHDR_P, USIGN, USIGN, STRUCT_TIMESPEC_P, 0}},
    {300, "fanotify_init", 2, NUM, {USIGN, USIGN, 0, 0, 0, 0}},
    {301, "fanotify_mark", 5, NUM, {NUM, USIGN, UNUM64_T, NUM, STRING, 0}},
    {302, "prlimit64", 4, NUM,
        {NUM, NUM, CONST_STRUCT_RLIMIT_P, STRUCT_RLIMIT_P, 0, 0}},
    ...
    {305, "clock_adjtime", 2, NUM, {CLOCKID_T, STRUCT_TIMEX_P, 0, 0, 0, 0}},
    {306, "syncfs", 1, NUM, {NUM, 0, 0, 0, 0, 0}},
    {307, "sendmmsg", 4, NUM,
        {NUM, STRUCT_MMSGHDR_P, USIGN, USIGN, 0, 0}},
    {308, "setns", 2, NUM, {NUM, NUM, 0, 0, 0, 0}},
    {309, "getcpu", 3, NUM,
        {USIGN_P, USIGN_P, STRUCT__CACHE_P, 0, 0, 0}},
    {310, "process_vm_readv", 6, NUM,
        {NUM, CONS_STRUC_IOVEC_P, USIGN, CONS_STRUC_IOVEC_P, USIGN, USIGN}},
    {311, "process_vm_writev", 6, NUM,
        {NUM, CONS_STRUC_IOVEC_P, USIGN, CONS_STRUC_IOVEC_P, USIGN, USIGN}},
    {312, "kcmp", 5, NUM,
        {NUM, NUM, NUM, USIGN, USIGN, 0}},
    {313, "finit_module", 3, NUM,
        {NUM, STRING, NUM, 0, 0, 0}},
    {314, "sched_setattr", 3, NUM,
        {NUM, STRUCT_SCHED_ATTR_P, USIGN, 0, 0, 0}},
    {315, "sched_getattr", 4, NUM,
        {NUM, STRUCT_SCHED_ATTR_P, USIGN, USIGN, 0, 0}},
    {316, "renameat2", 5, NUM,
        {NUM, STRING, NUM, STRING, USIGN, 0}},
    {317, "seccomp", 3, NUM,
        {USIGN, USIGN, VOID_P, 0, 0, 0}},
    {318, "getrandom", 3, NUM,
        {VOID_P, NUM, USIGN, 0, 0, 0}},
    {319, "memfd_create", 2, NUM,
        {STRING, USIGN, 0, 0, 0, 0}},
    {320, "kexec_file_load", 5, NUM,
        {NUM, NUM, USIGN, STRING, USIGN, 0}},
    {321, "bpf", 3, NUM,
        {NUM, UNION__ATTR_P, USIGN, 0, 0, 0}},
    {322, "execveat", 5, NUM,
        {NUM, STRING, STRING, STRING, NUM, 0}},
    {323, "userfaultfd", 1, NUM,
        {NUM, 0, 0, 0, 0, 0}},
    {324, "membarrier", 2, NUM,
        {NUM, NUM, 0, 0, 0, 0}},
    {325, "mlock2", 3, NUM,
        {CONST_VOID_P, NUM, NUM, 0, 0, 0}},
    {326, "copy_file_range", 6, NUM,
        {NUM, LNUM_P, NUM, LNUM_P, NUM, USIGN}},
    {327, "preadv2", 5, NUM,
        {NUM, CONS_STRUC_IOVEC_P, NUM, NUM, NUM, 0}},
    {328, "pwritev2", 5, NUM,
        {NUM, CONS_STRUC_IOVEC_P, NUM, NUM, NUM, 0}},
    {-1, NULL, 0, 0,
        {0, 0, 0, 0, 0, 0}}
