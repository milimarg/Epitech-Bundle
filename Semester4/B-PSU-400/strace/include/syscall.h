...
static const syscall_t table[330] = {
    ...
    {148, "sched_rr_get_interval", 2, NUM, NUM, STRUCT_TIMESPEC_P_, 0, 0, 0,
        0}, {149, "mlock", 2, NUM, CONST_VOID_P, NUM, 0, 0, 0, 0},
    ...
    {274, "get_robust_list", 3, NUM, NUM, STRUCT_ROBUST_LIST_HEAD_P, NUM_P, 0,
        0, 0}, {275, "splice", 6, NUM, NUM, LNUM_P, NUM, LNUM_P, NUM,
        UNSIGNED}, {276, "tee", 4, NUM, NUM, NUM, NUM, UNSIGNED, 0, 0},
    ...
    {279, "move_pages", 6, NUM, NUM, UNSIGNED, VOID_P, CONST_NUM_P, NUM_P,
        NUM}, {280, "utimensat", 4, NUM, NUM, STRING, CONST_STRUCT_TIMESPEC,
        NUM, 0, 0}, {281, "epoll_pwait", 5, NUM, NUM, STRUCT_EPOLL_EVENT_P,
        NUM, NUM, CONST_SIGSET_T_P, 0},
    ...
    {304, "open_by_handle_at", 3, NUM, NUM, STRUCT_FILE_HANDLE_P, NUM, 0, 0,
        0}, {305, "clock_adjtime", 6, 0, 0, 0, 0, 0, 0, 0},
    ...
    {314, "sched_setattr", 3, NUM, NUM, STRUCT_SCHED_ATTR_P, UNSIGNED, 0, 0,
        0}, {315, "sched_getattr", 4, NUM, NUM, STRUCT_SCHED_ATTR_P, UNSIGNED,
        UNSIGNED, 0, 0},
